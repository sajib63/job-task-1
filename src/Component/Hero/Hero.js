...
const Hero = () => {
  return (
    <div className="hero rounded-lg my-16">
      <div className="hero-content flex-col  lg:flex-row-reverse lg:gap-40 items-center justify-center my-24 ">
        <div>
          <img alt="" src={heroImage} className=" rounded-lg" />
        </div>

        <div>
          <h1 className="text-7xl font-bold text-[#30FBEF] mb-4">
          ...
          <button className="btn bg-[#313131] border-0 shadow-2xl rounded-l-full rounded-r-full w-48 p-2">
            Learn More
          </button>
        </div>
      </div>
